...
/**
 * ZtfxId generated by hbm2java
 */
@Embeddable
public class ZtfxId implements java.io.Serializable {
	...
	public ZtfxId(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ZtfxId))
			return false;
		ZtfxId castOther = (ZtfxId) other;
