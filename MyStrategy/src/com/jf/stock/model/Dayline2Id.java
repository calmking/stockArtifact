...
/**
 * Dayline2Id generated by hbm2java
 */
@Embeddable
public class Dayline2Id implements java.io.Serializable {
	...
	public Dayline2Id(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Dayline2Id))
			return false;
		Dayline2Id castOther = (Dayline2Id) other;
