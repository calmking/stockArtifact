...
/**
 * ZtdkId generated by hbm2java
 */
@Embeddable
public class ZtdkId implements java.io.Serializable {
	...
	public ZtdkId(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ZtdkId))
			return false;
		ZtdkId castOther = (ZtdkId) other;
