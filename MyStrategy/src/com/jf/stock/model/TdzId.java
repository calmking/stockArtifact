...
/**
 * TdzId generated by hbm2java
 */
@Embeddable
public class TdzId implements java.io.Serializable {
	...
	public TdzId(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TdzId))
			return false;
		TdzId castOther = (TdzId) other;
