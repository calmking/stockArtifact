...
/**
 * JsjId generated by hbm2java
 */
@Embeddable
public class JsjId implements java.io.Serializable {
	...
	public JsjId(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JsjId))
			return false;
		JsjId castOther = (JsjId) other;
