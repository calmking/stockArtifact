...
/**
 * QlcyId generated by hbm2java
 */
@Embeddable
public class QlcyId implements java.io.Serializable {
	...
	public QlcyId(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QlcyId))
			return false;
		QlcyId castOther = (QlcyId) other;
