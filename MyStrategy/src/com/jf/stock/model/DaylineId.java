...
/**
 * DaylineId generated by hbm2java
 */
@Embeddable
public class DaylineId implements java.io.Serializable {
	...
	public DaylineId(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DaylineId))
			return false;
		DaylineId castOther = (DaylineId) other;
