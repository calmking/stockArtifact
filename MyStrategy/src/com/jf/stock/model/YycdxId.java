...
/**
 * YycdxId generated by hbm2java
 */
@Embeddable
public class YycdxId implements java.io.Serializable {
	...
	public YycdxId(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof YycdxId))
			return false;
		YycdxId castOther = (YycdxId) other;
