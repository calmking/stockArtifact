...
/**
 * MacdId generated by hbm2java
 */
@Embeddable
public class MacdId implements java.io.Serializable {
	...
	public MacdId(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MacdId))
			return false;
		MacdId castOther = (MacdId) other;
