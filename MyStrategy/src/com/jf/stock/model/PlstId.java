...
/**
 * PlstId generated by hbm2java
 */
@Embeddable
public class PlstId implements java.io.Serializable {
	...
	public PlstId(String obj, int date) {
		this.obj = obj;
		this.date = date;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlstId))
			return false;
		PlstId castOther = (PlstId) other;
